...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(intSum); // intSum 변수의 값을 읽어서
									// Console 에 출력
		//키보드 뒤에 소괄호가 따라오면 ~메소드라 부른다.
		
		System.out.println(); // 괄호안에 값을 넣지 않으면 빈 줄을 한줄 만들어라
							  // println() 메서드
		/*
		...
		System.out.print(0); // 괄호안에 아무것도 넣지않으면 오류가 남
		System.out.print(0);
		System.out.print(0 + 0);
		System.out.print("대한민국");
		System.out.print("\n"); // 특수문자를 나타내고 싶으면 \하나더ex) "\\n" > "\n"으로 나타남
		System.out.println(); // 괄호안에 아무것도 넣지않아도 오류가 안남. 다음줄효과
