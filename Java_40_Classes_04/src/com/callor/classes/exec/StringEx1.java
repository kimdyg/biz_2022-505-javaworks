...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		String strNo2 = strNation.substring(0, 7);
				...
				/*
				 * str1.length() 메서는 문자열의 길이를 계산하는 method 이다
				...
				/*
				 * for() 반복문이 실행되기전에 문자열의 개수를 계산하여
				 * return 하는 length() 메서드를 호출하고
				 * 결과를 변수에 담자
				 * 이제는 문자열의 길이를 계산하는 코드는 한번만 실행되고
				 * 문자열의 길이만큼 for() 반복문을 수행 할 수 있게 되었다
				 * 상당히 많은 코드 실행이 없어져
				 * 효율적인 코드가 된다
				 */
