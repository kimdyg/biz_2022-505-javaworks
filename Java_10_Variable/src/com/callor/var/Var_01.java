...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		//선언된 정수형 변수 num3 에 정수 40을 대입하기
		//대입, 할당, 저장
		num3 = 40;
		//선언된 정수형 변수 num4 에 정수 100을 대입하기
		num4 = 100;
		/*
		...
		// 변수에 어떤 값을 저장해야 할 지 아직 정해지지 않았을때는
		...
		int intTelNum = 10596511;
		int intStAge= 33;
		System.out.println(intStAge);
