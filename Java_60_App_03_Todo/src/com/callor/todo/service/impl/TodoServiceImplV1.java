...
public class TodoServiceImplV1 implements TodoService {
	 ...
	 * key, 추가날씨, 시간 를 생성한 후 TodoVO 에 담고
	 * todoList에 추가하기
	 * 
	...
	public void todoInsert(String content) {
		...
		// System.currentTimeMillis() method 를주입해 주어야한다
	...
	@Override
	public TodoVO findByKet(String key) {
		// TODO Auto-generated method stub
		return null;
	}
...
//		todoList.get(num).setEdate(today);
		 ...
		 *  Date, Calender 클래스의 날짜와 관련된 많은 이슈
